                ...
                <div className="flex justify-between items-center">
                    ...
                    <div className="hidden md:block">
                        <ul className="flex justify-center items-center gap-8">
                            <li>
                                <Link className="text-[rgba(255, 255, 255, 0.8)] font-medium hover:text-[#667eea]
                    ...
                    <div className="hidden md:block">
                        <div className="flex gap-8">
                            <Link to="/auth">
                                <button className="text-[0.9rem] bg-transparent py-3 px-6 rounded-xl 
                           ...
                           <Link to="/auth">
                             <button className="text-[0.9rem] bg-[linear-gradient(135deg,#667eea_0%,#764ba2_100%)] 
            ...
            <div 
                ...
                <div className="px-6 py-4">
                    <ul className="flex flex-col justify-center">
                        <li className="border-b border-b-[rgba(255,255,255,0.05)] rounded-xl p-4"
                            onClick={() => handleMobileOpen()}>
                            <Link className="text-[rgba(255,255,255,0.8)] font-medium hover:text-[#667eea]
                                transition-colors duration-300 ease-in-out">
                                Home
                ...
                <div className="flex flex-col gap-4 border-t border-t-white/30 p-6">
                    <div onClick={() => handleMobileOpen()}>
                        <Link className="w-full block text-center text-[0.9rem] bg-transparent py-3 px-6 rounded-xl 
                            font-semibold cursor-pointer transition-all duration-300 
                            ease-in-out text-[rgba(255,255,255,0.9)] border border-[rgba(255,255,255,0.2)]
                            hover:bg-[rgba(255,255,255,0.1)] hover:border-[rgba(255,255,255,0.3)]">
                            Login
                    ...
                    <div onClick={() => handleMobileOpen()}>
                        <Link className="w-full block text-center text-[0.9rem] bg-[linear-gradient(135deg,#667eea_0%,#764ba2_100%)] 
                            shadow-[0_4px_15px_rgba(102,126,234,0.3)] py-3 px-6 rounded-xl 
                            font-semibold cursor-pointer transition-all duration-300 
                            ease-in-out text-white
                            hover:translate-y-[-2px] hover:shadow-[0_8px_25px_rgba(102,126,234,0.4)]">
