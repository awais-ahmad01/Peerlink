...
const CameraSection = () => {
  ...
  // 👇 Enhanced dynamic grid calculation with better mobile responsiveness
  const totalUsers = 1 + Object.keys(remoteUsers).length;
  let gridCols = "grid-cols-1";

  if (totalUsers === 2) {
    // Mobile: 1 column (2 rows), Tablet and up: 2 columns
    ...
    // Mobile: 2 per row, Tablet and up: 3 per row
    gridCols = "grid-cols-2 md:grid-cols-3";
  ...
  return (
    <div className="pt-28 md:pt-36">
      <div className="relative flex h-[calc(100vh-180px)] p-4 gap-4">
        ...
        >
          {totalUsers === 1 ? (
            // 🟢 Show only local user fullscreen when alone
            ...
            // 🟢 Enhanced grid mode with better mobile responsiveness
            <div
...
//   const copyRoomLink = () => {
//     const roomUrl = `${window.location.origin}/call-room/${roomId}`;
